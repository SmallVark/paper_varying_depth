...
{\bf So far the effects of varying depth have not been extensively studied: \citet{Guzik:2005} investigate the effect of a general, position-dependent multiplicative shear bias on the shear power spectrum through simulations, but do not perform a quantitative analysis. Furthermore, varying depth was one of the effects included in mock catalogs in the Subaru Hyper Suprime-Cam Survey \citep{Shirasaki:2019}, but they did not discuss its implications in detail.
}
